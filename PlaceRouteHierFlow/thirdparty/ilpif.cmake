...
target_link_libraries(ILPSolverIf_shared PRIVATE ${symphony_LIBRARIES} ${cbc_LIBRARIES})]=]
    ...
    set(_ilp_link_libs ilp_solver_if osicbc_if cbcsolver_if cbc_if cgl_if osiclp_if clpsolver_if clp_if osi_if coinutils_if)
    if(sym_lib)
      set_property(TARGET sym_if PROPERTY IMPORTED_LOCATION ${sym_lib})
      list(APPEND _ilp_link_libs sym_if)
    endif()
    if(osisym_lib)
      set_property(TARGET osisym_if PROPERTY IMPORTED_LOCATION ${osisym_lib})
      list(APPEND _ilp_link_libs osisym_if)
    endif()
    target_link_libraries(ilp_solver INTERFACE ${_ilp_link_libs})
